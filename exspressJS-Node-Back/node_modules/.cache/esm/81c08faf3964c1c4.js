let con;_396‍.x([["getTask",()=>getTask],["getTasks",()=>getTasks],["getCounterTasks",()=>getCounterTasks],["addTask",()=>addTask],["updateTask",()=>updateTask],["changeTaskStatus",()=>changeTaskStatus],["changeTaskLevel",()=>changeTaskLevel],["removeTask",()=>removeTask],["returnTask",()=>returnTask]]);_396‍.w("../sqlConnect",[["con",["con"],function(v){con=v}]]);

       function getTask(req, res) {
    con.query("SELECT * FROM `tasks` WHERE `id` = ? AND `userId` = ?", [req.params.id, req.session.user.id], (err, result) => {
        if (err) {
            _396‍.g.console.log(err);
        }
